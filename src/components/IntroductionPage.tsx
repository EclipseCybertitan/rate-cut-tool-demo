  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-black to-gray-800 relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute top-60 left-1/4 w-1.5 h-1.5 bg-cyan-400 rounded-full animate-bounce"></div>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="space-y-4">
                <div className="flex items-start space-x-3 group">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-white mb-2 group-hover:text-green-300 transition-colors duration-300">美联储政策转向</h3>
                ...
                <div className="flex items-start space-x-3 group">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-white mb-2 group-hover:text-blue-300 transition-colors duration-300">历史机遇窗口</h3>
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-3 group">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-white mb-2 group-hover:text-yellow-300 transition-colors duration-300">风险分散需求</h3>
                ...
                <div className="flex items-start space-x-3 group">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-white mb-2 group-hover:text-red-300 transition-colors duration-300">技术驱动分析</h3>
