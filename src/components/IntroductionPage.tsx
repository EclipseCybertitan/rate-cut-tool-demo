    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-black to-gray-800 relative overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-4 py-8 min-h-screen flex flex-col justify-center">
            ...
            <div className="bg-gradient-to-r from-blue-900/30 to-cyan-900/30 p-8 rounded-3xl border border-blue-600/30 backdrop-blur-sm">
              ...
              <div className="grid md:grid-cols-3 gap-6 text-center">
                <div className="space-y-3">
                  ...
                  <h3 className="text-lg font-semibold text-white">智能匹配</h3>
                  <p className="text-sm text-gray-300">分析您的风险偏好，匹配最适合的投资策略</p>
                </div>
                <div className="space-y-3">
                  ...
                  <h3 className="text-lg font-semibold text-white">偏好诊断</h3>
                  <p className="text-sm text-gray-300">深度分析您的投资心理和决策模式</p>
                </div>
                <div className="space-y-3">
                  ...
                  <h3 className="text-lg font-semibold text-white">周期把握</h3>
                  <p className="text-sm text-gray-300">精准识别降息周期，优化资产配置时机</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-4xl mx-auto mb-16">
          <div className="bg-gradient-to-r from-purple-900/30 to-pink-900/30 p-8 rounded-3xl border border-purple-600/30 backdrop-blur-sm">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-white mb-2">美联储政策转向</h3>
                    <p className="text-gray-300">2025年下半年降息预期上升，市场环境即将发生重大变化</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="w-3 h-3 bg-blue-400 rounded-full mt-2 flex-shrink-0"></div>
                  <div>
                    <h3 className="text-lg font-semibold text-white mb-2">历史机遇窗口</h3>
                    <p className="text-gray-300">降息周期往往带来资产价格重估，提前布局至关重要</p>
                  </div>
                </div>
              </div>
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-white mb-2">风险分散需求</h3>
                    <p className="text-gray-300">经济不确定性增加，多元化资产配置成为必要选择</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="w-3 h-3 bg-red-400 rounded-full mt-2 flex-shrink-0"></div>
                  <div>
                    <h3 className="text-lg font-semibold text-white mb-2">技术驱动分析</h3>
                    <p className="text-gray-300">AI算法和机器学习技术，让投资决策更加科学精准</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="text-center">
          <button
            onClick={onNext}
            className="group relative inline-flex items-center justify-center px-12 py-6 text-xl font-bold text-white bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 rounded-2xl shadow-2xl transform hover:scale-105 transition-all duration-300 overflow-hidden"
          >
